...
public class siren extends AppCompatActivity implements MyMediaPlayer.MyMediaPlayerInterface {
    ...
    private void displaySirenNotification(){
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat
                ...
                .setContentTitle("Som de Sirene")
                .setContentText("Play ou pause na sirente")
                .setPriority(Notification.PRIORITY_LOW)
                .setAutoCancel(false)
                .setContentIntent(pendingIntent)
                .addAction(R.mipmap.stop,"PLAY",playPendingIntent)
                .addAction(R.mipmap.stop,"PAUSAR",pausePendingIntent);
    ...
    public void onPauseClicked() {
        Toast.makeText(this,"Sirene pausada",Toast.LENGTH_SHORT).show();
        decide(2);
    }
}